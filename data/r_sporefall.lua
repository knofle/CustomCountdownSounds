...
local sporefall = {

    {
        ...
        abilities = {
            { key = "shroomling_fixate",    label = "Shroomling Fixate",    privateID = 1221639, soundH = "file:shroomling",        soundM = "file:shroomling",     }, -- Small shitters
            { key = "fungling_fixate",      label = "Fungling Fixate",      privateID = 1299508, soundH = "file:fungling",          soundM = "file:fungling",       }, -- Maybe another fixate?
            { key = "festering_vines",      label = "Festering Vines",      privateID = 1222088, soundH = {"drop","file:8s"},       soundM = {"drop","file:8s"},    }, -- 8 Second dot/slow, leaves Writhing Vines
