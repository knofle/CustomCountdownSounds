...
CCS_Spells_Mplus_VoidscarArena = {
    {
        ...
        abilities = {
            ...
            { key = "va_nether_dash_dot",           label = "Nether Dash (dot)",                privateID = 1222103,                soundM = "file:dot",                     advanced = true, desc = "You got clipped by a dash. Shadow dot for 15s, just heal through it." },
...

    {
        ...
        abilities = {
            ...
            { key = "va_hulking_claw",              label = "Hulking Claw",                     privateID = 1222642,                soundM = nil,                            advanced = true, desc = "Tank hit, heavy nature damage plus a dot. Just heal through it." },
            ...
            { key = "va_sickening_bite",            label = "Sickening Bite",                   privateID = 1282892,                soundM = nil,                            advanced = true, desc = "Toxic Creeper bit you: 50% more nature damage taken, stacks. Kill the creeper and heal through it." },
        },
    },
...

    {
        ...
        abilities = {
            ...
            { key = "va_demoralizing_shout",        label = "Demoralizing Shout",               privateID = 1298899,                soundM = nil,                            advanced = true, desc = "Trash debuff, 25% less damage done for a bit. Just heal through it." },
