...
CCS_Spells_Mplus_RubyLifePools = {
    {
        ...
        abilities = {
            ...
            { key = "rlp_chillstorm_dot",           label = "Chillstorm (Dot)",                 privateID = 397077,                 soundM = nil,                               advanced = true },
            { key = "rlp_cold_claws",               label = "Cold Claws",                       privateID = 1305234,                soundM = nil,                               advanced = true },
            { key = "rlp_frost_overload",           label = "Frost Overload",                   privateID = 373688,                 soundM = "file:break" },
...

    {
        ...
        abilities = {
            ...
            { key = "rlp_earthbounds_imprint",      label = "Earthbound's Imprint",             privateID = 1307205,                soundM = nil,                               advanced = true    },
            ...
            { key = "rlp_lightning_torrent",        label = "Lightning Torrent",                privateID = 1306366,                soundM = nil,                               advanced = true   },
            { key = "rlp_electrical_discharge",     label = "Electrical Discharge",             privateID = 1310599,                soundM = nil,                               advanced = true    },
            { key = "rlp_lightning_rod",            label = "Lightning Rod",                    privateID = 385313,                 soundM = nil,                               advanced = true    },
