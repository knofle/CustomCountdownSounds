...
CCS_Spells_Mplus_MurderRow = {
...

    {
        ...
        abilities = {
            ...
            { key = "mr_heartstop_poison_boss",     label = "Heartstop Poison",                 privateID = 474515,                 soundM = nil,                           advanced = true },
...

    {
        ...
        abilities = {
            { key = "mr_demonic_gateway_travel",    label = "Demonic Gateway (travel)",         privateID = 1214730,                soundM = nil,                            advanced = true }, -- 3s travel
            { key = "mr_demonic_gateway_cd",        label = "Demonic Gateway (cooldown)",       privateID = 1214740,                soundM = nil,                            advanced = true }, -- 30s cannot use
            { key = "mr_malefic_wave",              label = "Malefic Wave",                     privateID = 1217384,                soundM = nil,                            advanced = true },
            { key = "mr_fingers_guldan",            label = "Fingers of Gul'dan",               privateID = {474457,474462,1218203 },     soundM = "spread",                                     },
...

    {
        ...
        abilities = {
            { key = "mr_fel_missiles",              label = "Fel Missiles",                     privateID = 1216571,                soundM = nil,                           advanced = true    },          
            { key = "mr_heartstop_poison_trash",    label = "Heartstop Poison",                 privateID = 1216590,                soundM = nil,                           advanced = true    },
            { key = "mr_corroding_spittle_trash",   label = "Corroding Spittle",                privateID = 1217633,                soundM = nil,                           advanced = true    },
            { key = "mr_shield_bash",               label = "Shield Bash",                      privateID = 1216529,                soundM = nil,                           advanced = true    },
            { key = "mr_cutpurse",                  label = "Cutpurse",                         privateID = 1216300,                soundM = nil,                           advanced = true    },
            ...
            { key = "mr_seduction",                 label = "Seduction",                        privateID = 1201554,                soundM = nil,                           advanced = true    },
            { key = "mr_fel_beam_damage",           label = "Fel Beam (damage)",                privateID = 1215985,                soundM = nil,                           advanced = true    },
            { key = "mr_fel_beam_target",           label = "Fel Beam",                         privateID = 1218187,                soundM = {"file:beam" },                                    },
            { key = "mr_server",                    label = "Server",                           privateID = 1218465,                soundM = "file:serve",                                      },
            { key = "mr_cleaner",                   label = "Cleaner",                          privateID = 1218466,                soundM = "file:clean",                                      },
            { key = "mr_entertainer",               label = "Entertainer",                      privateID = 1218467,                soundM = "file:collect",                                    },
            { key = "mr_bouncer",                   label = "Bouncer",                          privateID = 1218468,                soundM = "file:bounce",                                     },  
        },
    },
}