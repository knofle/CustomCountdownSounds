...
CCS_Spells_Mplus_TempleOfSethraliss = {
...

    {
        ...
        abilities = {
            ...
            { key = "tos_conduct_lightning",        label = "Conduct Lightning",                privateID = 1296068,                soundM = nil,                           advanced = true    },
            { key = "tos_venomous_slash",           label = "Venomous Slash",                   privateID = 1308546,                soundM = nil,                           advanced = true    },
            { key = "tos_shadowlash",               label = "Shadowlash",                       privateID = 1300714,                soundM = nil,                           advanced = true     },
            ...
            { key = "tos_poisoned_cheap_shot",      label = "Poisoned Cheap Shot",              privateID = 1308100,                soundM = nil,                            advanced = true    },
        },
    },
}