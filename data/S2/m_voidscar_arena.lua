...
CCS_Spells_Mplus_VoidscarArena = {
...

    {
        ...
        abilities = {
            ...
            { key = "va_poison_splash",             label = "Poison Splash",                    privateID = 1226031,                soundM = nil,                            advanced = true },
            { key = "va_sickening_bite",            label = "Sickening Bite",                   privateID = 1282892,                soundM = nil,                            advanced = true },
        },
    },
