...
local entries = {
    ...
    },
    {
        ...
        abilities = {
            ...
            --{ key = "debilitating_miasma",      label = "Debilitating Miasma",          privateID = 1284477,                    soundH = nil,                               soundM = nil,                       advanced = true                     }, -- ok Not on live
    ...
    },
    {
        ...
        abilities = {
            ...
            { key = "plague_froth_mythic",          label = "Plague Froth",                 privateID = {1281908,1281913},      soundH = {"spread","file:8s" },             soundM = {"spread","file:6s" }                                          }, -- ok
    ...
    },
    {
        ...
        abilities = {
            { key = "dreadmarch",                   label = "Dreadmarch (Target)",          privateID = 1297435,                soundH = "file:dreadmarch",                 soundM = "file:dreadmarch"                                               }, -- ok
            { key = "dreadmarch_eff",               label = "Dreadmarch (Debuff)",          privateID = 1297445,                soundH = nil,                               soundM = nil,                       advanced = true                                     }, -- ok
                                                      
            { key = "unnerving_fixation",           label = "Unnerving Fixation",           privateID = 1285911,                soundH = "fixate",                          soundM = "fixate"                                                        }, -- ok
            { key = "gloombomb",                    label = "Gloombomb",                    privateID = {1286901,1310881},      soundH = {"file:bomb","file:5s" },          soundM = {"file:bomb","file:5s" },                                      }, -- ok            
            { key = "gravebound",                   label = "Gravebound",                   privateID = 1286837,                soundH = "file:collect",                    soundM = "file:collect"                                              }, -- ok
            ...
            { key = "guillotine",                   label = "Guillotine (Target)",          privateID = 1283485,                soundH = {"file:guillotine","file:5s"},     soundM = {"file:guillotine","file:5s"},                                           }, -- ok
            { key = "guillotined",                  label = "Guillotine (Debuff)",          privateID = 1307425,                soundH = nil,                               soundM = nil,                       advanced = true                     }, -- ok            
            { key = "grim_guillotine_tg",           label = "Grim Guillotine (Target)",     privateID = 1299266,                soundH = {"file:guillotine","file:5s"},     soundM = {"file:guillotine","file:5s"},                                           }, -- ok           
            { key = "grim_guillotine_db",           label = "Grim Guillotine (Debuff)",     privateID = 1307652,                soundH = nil,                               soundM = nil,                       advanced = true                    }, -- ok            
