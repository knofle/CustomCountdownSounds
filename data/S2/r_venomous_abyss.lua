...
local entries = {
    ...
    },
    {
        ...
        abilities = {
            ...
            { key = "blink_nova",                   label = "Blink Nova",                   privateID = {1296025,1296021,1292793,1290711,1294334,1290740,1290742,1290743,129279},           soundH = {"file:blink","file:9s"},          soundM = {"file:blink","file:9s"},       }, -- does not show on logs            
            { key = "frostfire_volley_fire",        label = "Frostfire Volley (Fire)",      privateID = {1295886,1295893,1295891,1295895},   soundH = {"file:fire_volley","file:7s"},       soundM = {"file:fire_volley","file:7s"},    suggest = {"file:fire"},    }, --tooltip says 8s, but might be 7s based on testing?
            { key = "frostfire_volley_frost",       label = "Frostfire Volley (Frost)",     privateID = {1295935,1295985,1295945,1295948},   soundH = {"file:frost_volley","file:7s"},      soundM = {"file:frost_volley","file:7s"},   suggest = {"file:frost"},   },  --tooltip says 8s, but might be 7s based on testing?          
            { key = "burning_flames",               label = "Burning Flames",               privateID = 1295928,                soundH = nil,                               soundM = nil,                               soundRemove = "file:clear", },
            { key = "piercing_frost",               label = "Piercing Frost",               privateID = 1295954,                soundH = nil,                               soundM = nil,                               soundRemove = "file:clear", },
            { key = "explosive_surprise",           label = "Explosive Surprise",           privateID = 1297625,                soundH = {"file:bomb","file:10s"},          soundM = {"file:bomb","file:10s"},                                      },            
    ...
    },
    {
        ...
        abilities = {
            ...
            { key = "surging_fang",                 label = "Surging Fang",                 privateID = {1288879,1295876,1293146 }, soundH = "file:fang",                    soundM = "file:fang",                      advanced = true     },            
            { key = "volatile_purge",               label = "Volatile Purge",               privateID = 1306086,                soundH = {"file:purge","file:6s" },          soundM = {"file:purge","file:6s" },     advanced = true},
            { key = "doomscale_pheromones",         label = "Doomscale Pheromones",         privateID = 1300265,                soundH = "file:pheromones",                 soundM = "file:pheromones",              advanced = true},
