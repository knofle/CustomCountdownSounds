...
CCS_Spells_Mplus_DenOfNalorakk = {
...

    {
        ...
        abilities = {
            { key = "dn_echoing_maul",              label = "Echoing Maul",                     privateID = 1242869,                soundM = {"spread","file:4s" } },
            { key = "dn_forceful_slam",             label = "Forceful Slam",                    privateID = 1297797,                soundM = nil,                            advanced = true },
            { key = "dn_spectral_slash",            label = "Spectral Slash",                   privateID = 1255577,                soundM = nil,                            advanced = true },
            --{ key = "dn_overwhelming_onslaught",    label = "Overwhelming Onslaught",           privateID = 1297792,                soundM = nil,                            advanced = true },
            ...
            { key = "dn_demoralizing_scream",       label = "Demoralizing Scream",              privateID = 1262253,                soundM = nil,                            advanced = true },
            { key = "dn_defensive_stance",          label = "Defensive Stance",                 privateID = 1261781,                soundM = nil,                            advanced = true },
        },
    },

    {
        ...
        abilities = {
            { key = "dn_insatiable_hunger",         label = "Insatiable Hunger",                privateID = 1238801,                soundM = "file:totem",                                  },
            { key = "dn_feast_of_misery",           label = "Feast of Misery",                  privateID = 1238687,                soundM = nil,                       advanced = true    },            
            { key = "dn_shredding_claws",           label = "Shredding Claws",                  privateID = 1238247,                soundM = nil,                       advanced = true    },

            { key = "dn_carrying_supplies",         label = "Carrying Supplies",                privateID = 1239428,                soundM = nil,                       advanced = true    },
            { key = "dn_sheltered",                 label = "Sheltered",                        privateID = 1233904,                soundM = nil,                       advanced = true    },
            { key = "dn_razor_dive",                label = "Razor Dive",                       privateID = 1238439,                soundM = nil,                       advanced = true    },
            { key = "dn_glacial_tomb",              label = "Glacial Tomb",                     privateID = 1241464,                soundM = nil,                       advanced = true    },
            { key = "dn_fixate",                    label = "Fixate",                           privateID = 1246882,                soundM = "file:fixate",                                          },
            { key = "dn_primal_echo",               label = "Primal Echo",                      privateID = 1246957,                soundM = nil,                       advanced = true    },
            { key = "dn_cryo_surge",                label = "Cryo Surge",                       privateID = 1239860,                soundM = "file:spread",                                          },
            { key = "dn_pulverize",                 label = "Pulverize",                        privateID = 1240280,                soundM = nil,                       advanced = true    },
            ...
            { key = "dn_shred_armor",               label = "Shred Amor",                       privateID = 1311695,                soundM = nil,                       advanced = true    },            
