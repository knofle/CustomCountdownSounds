...
CCS_Spells_Mplus_KingsRest = {
...

    {
        ...
        abilities = {
            ...
            { key = "kr_wretched_discharge",        label = "Wretched Discharge",               privateID = 267763,                 soundM = "file:dot",                     advanced = true },
...

    {
        ...
        abilities = {
            ...
            { key = "kr_barrel_through",            label = "Barrel Through",                   privateID = 267494,                 soundM = {"file:targeted","file:6s" } },
            { key = "kr_severing_axe",              label = "Severing Axe",                     privateID = 266231,                 soundM = "file:dot",                     advanced = true },
            { key = "kr_bloodthirsty_axe",          label = "Bloodthirsty Axe",                 privateID = 1301851,                soundM = "file:dot",                     advanced = true },
            { key = "kr_shattered_defenses",        label = "Shattered Defenses",               privateID = 266238,                 soundM = "debuff",                       advanced = true },
        },
    },

    {
        ...
        abilities = {
            ...
            { key = "kr_hunting_leap",              label = "Hunting Leap",                     privateID = 1303039,                soundM = nil,                            advanced = true },
