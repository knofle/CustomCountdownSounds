...
CCS_Spells_Mplus_DenOfNalorakk = {
...

    {
        ...
        abilities = {
            ...
            { key = "dn_winters_shroud",            label = "Winter's Shroud",                  privateID = 1235829,                soundM = nil,                            advanced = true    }, -- Private aura, confirmed by BigWigs
            { key = "dn_raging_squall",             label = "Raging Squall",                    privateID = 1235641,                soundM = nil,                            advanced = true    }, -- Private aura, confirmed by BigWigs
        },
    },

    {
        ...
        abilities = {
            { key = "dn_echoing_maul",              label = "Echoing Maul",                     privateID = 1242869,                soundM = {"targeted","file:4s" }                            },
            ...
            { key = "dn_demoralizing_scream",       label = "Demoralizing Scream",              privateID = 1262253,                soundM = nil,                            advanced = true    }, -- Private aura
            { key = "dn_defensive_stance",          label = "Defensive Stance",                 privateID = 1261781,                soundM = nil,                            advanced = true    }, -- Private aura
        },
    },
