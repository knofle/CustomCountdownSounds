...
CCS_Spells_Mplus_MurderRow = {
...

    {
        ...
        abilities = {
            { key = "mr_murder_in_row",             label = "Murder in a Row (target)",         privateID = 474545,                 soundM = "targeted"                                         },
            { key = "mr_fire_bomb",                 label = "Fire Bomb",                        privateID = 1214352,                soundM = {"break","file:6s"}                                },
...

    {
        ...
        abilities = {
            { key = "mr_axe_toss",                  label = "Axe Toss",                         privateID = 1214637,                soundM = {"targeted","file:3,5s"},                          },
            { key = "mr_fel_lightning",             label = "Fel Lightning",                    privateID = 1214650,                soundM = nil,                            advanced = true    },
            { key = "mr_infernal_crush",            label = "Infernal Crush",                   privateID = 1295455,                soundM = nil,                            advanced = true    },
